...
public class JFModificarDatosArticulo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFModificarDatosArticulo frame = new JFModificarDatosArticulo();
	...
	/**
		 * Create the frame.
		 */
		public JFModificarDatosArticulo() {
			setResizable(false);
			...
			txtDescripcion.setText("Datos previos");
			...
			txtPrecio.setText("Datos previos");
			...
			txtCantidad.setText("Datos previos");
			...
			btnAceptar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					OperadorCrud.updateArticulo(Descripcion, Precio, Cantidad, JFModificarArticulo.id );
				}
			});
